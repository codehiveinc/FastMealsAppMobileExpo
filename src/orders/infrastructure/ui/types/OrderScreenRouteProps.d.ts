...
export type MyOrdersHistoryAdminScreenRouteProps = NativeStackScreenProps<
  RootStackParamList,
  "MyOrdersHistoryAdminScreen"
>;

export type OrderAdminScreenRouteProps = NativeStackScreenProps<
  RootStackParamList,
  "OrderAdminScreen"
>;
