...
const PrivacyPolicyScreen = ({ navigation }: PrivacyPolicyScreenRouteProps) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.privacyPolicyContainer}>
        ...
        <Text style={styles.paragraph}>
          ...
          cómo recopilamos, utilizamos, y compartimos su información cuando usa
          nuestra aplicación.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          {"\n"}- Información de Pago: Recopilamos datos necesarios para
          procesar sus pagos, como información de tarjetas de crédito o cuentas
          de PayPal.
        ...
        <Text style={styles.paragraph}>
          ...
          {"\n"}- Datos de Uso: Recopilamos datos sobre su interacción con
          nuestra aplicación, como las páginas visitadas, el tiempo de uso y las
          acciones realizadas.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          {"\n"}- Proveedores de Servicios: Terceros que nos ayudan a
          proporcionar servicios, como procesamiento de pagos y entrega de
          pedidos.
        ...
        <Text style={styles.paragraph}>
          ...
          Sin embargo, ninguna transmisión de datos por Internet o sistema de
          almacenamiento es completamente seguro, por lo que no podemos
        ...
        <Text style={styles.paragraph}>
          ...
          para cumplir con los fines descritos en esta Política de Privacidad, a
          menos que se requiera o permita un período de retención más largo por
          ley.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          aplicación o por otros medios apropiados antes de que el cambio entre
          en vigor.
        </Text>
